...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeContactInfo() {
        ...
        contactItems.forEach(item => {
            item.addEventListener('click', function() {
                ...
                } else if (type.includes('map-marker')) {
                    action = '复制地址';
                    value = '辽宁省大连市甘井子区凌水路1号，大连海事大学';
                }
    ...
    function initializeMap() {
        ...
        mapContainer.addEventListener('click', function() {
            // Show map modal or redirect to map service
            showNotification('正在打开地图服务...', 'info');
            
            // Simulate opening map
            setTimeout(() => {
                const address = encodeURIComponent('辽宁省大连市甘井子区凌水路1号 大连海事大学');
